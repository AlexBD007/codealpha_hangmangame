...
lives = 7
user_name = input("Enter your name first please: ")
...
while not Game_over:
    ...
    if guess in correct_letters:
        print(f"You already guessed that letter {guess} {user_name}!.")
    ...
    if lives == 0:
        Game_over = True
        print(f"You lose bro {user_name} 😟 hangman is complete. The word was", Choosen_word+".")
